...
if __name__ == "__main__":
    ...
    test_patient = args_scanvi.test_patient
    ...
    print(f"Patient {test_patient} Weighted accuracy of SCANVI is : {np.mean(np.diag(cm_norm))}")
    print(f"Patient {test_patient} Unweighted accuracy of SCANVI is : {np.diag(cm).sum()/cm.sum()}")
