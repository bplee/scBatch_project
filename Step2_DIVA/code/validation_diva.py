...
if __name__ == "__main__":
    ...
    # Model name
    print(args.outpath)
    model_name = f"{args.outpath}210421_rcc_validation_test_pat_{args.test_patient}_train_pat_{args.train_patient}"
    fig_name = f"210421_rcc_validation_test_pat_{args.test_patient}_train_pat_{args.train_patient}"
    print(model_name)
