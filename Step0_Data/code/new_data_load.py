...
if __name__ == "__main__":
    ...
    raw_counts = readRDS('200929_raw_counts.rds') # this list of counts was generated by opening the seurat obj in R and saving the raw counts to a df for saveRDS
