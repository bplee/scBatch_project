...
if __name__ == "__main__":
    ...
    # Model name
    print(args.outpath)
    model_name = f"{args.outpath}210309_rcc_only_test_no_conv_semi_sup_seed_{args.seed}"
    fig_name = f"210309_rcc_only_test_no_conv_semi_sup_seed_{args.seed}"
    print(model_name)
    ...
    rcc_adata.obs['batch'][rcc_adata.obs.patient == "t4"] = "1"
