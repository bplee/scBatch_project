"""
script to run the scBatch package code on TIC dataset
"""
...
from Step6_RCC_to_CRC.code.rcc_to_crc_diva import get_validation_from_training
...
if __name__ == "__main__":
    ...
    diva_obj.fit(adata, model_name="test_model")
