...
#TODO:
# - code up default arg sizes somewhere
#   - encoding dim should be set to 512
# - allow default args to be changed
...
class px(nn.Module):
    def __init__(self, d_dim, x_dim, y_dim, zd_dim, zx_dim, zy_dim, encoding_dim):
        ...
        self.fc1 = nn.Sequential(nn.Linear(zy_dim, encoding_dim, bias=False), nn.ReLU())
...
class DIVA(nn.Module):
    ...
    def forward(self, d, x, y):
        ...
        # Decode
        x_recon = self.px(None, None, zy_q)
        ...
        #       tensor,  None, value, None,None,None,None,None, None,dist,dist, value
    ...
    def loss_function(self, d, x, y=None):
        ...
        # x_recon, y_hat, qzy, pzy, zy_q are not None, everything else is None
