...
from model.model_diva import DIVA
...
if __name__ == "__main__":
    ...
    # Model name
    print(args.outpath)
    model_name = args.outpath + 'rcc_test_domain_' + str(args.test_patient) + '_sup_only_seed_' + str(
        args.seed)+'_x_dim_'+str(args.x_dim)
    print(model_name)
    ...
    train_loader = data_utils.DataLoader(
        RccDataset(args.test_patient, args.x_dim,
                     train=True),
